...
$(document).scroll(function() {
	...
	if (scrollTop > scrollDistance) {
		$('.header, .mobile-bar').addClass('_scroll');
		$(body).css('padding-top', 'scrollDistance'+'px');
	} else {
		$('.header, .mobile-bar').removeClass('_scroll');
	}
});